...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                return await query.answer(get(lang, "THANK_YOU_ANSWER"))
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton(get_btn(lang, "BTN_MANUAL_FILTER"), callback_data='manuelfilter'),
            InlineKeyboardButton(get_btn(lang, "BTN_AUTO_FILTER"), callback_data='autofilter')
        ], [
            InlineKeyboardButton(get_btn(lang, "BTN_CONNECTION_MENU"), callback_data='coct'),
            InlineKeyboardButton(get_btn(lang, "BTN_EXTRA_MODS"), callback_data='extra')
        ], [
            InlineKeyboardButton(get_btn(lang, "BTN_HOME"), callback_data='start'),
            InlineKeyboardButton(get_btn(lang, "BTN_STATUS"), callback_data='stats')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton(get_btn(lang, "BTN_GROUP_LINK_STYLE"), url='https://t.me/filmykeedha_search'),
            InlineKeyboardButton(get_btn(lang, "BTN_SOURCE"), callback_data='source')
        ], [
            InlineKeyboardButton(get_btn(lang, "BTN_HOME"), callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton(get_btn(lang, "BTN_BACK_STYLIZED"), callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton(get_btn(lang, "BTN_BACK_STYLIZED"), callback_data='manuelfilter')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
    ...
    await query.answer(get(lang, "THANK_YOU_ANSWER"))
