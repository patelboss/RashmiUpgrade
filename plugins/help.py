...
from plugins.Extra.postc import get_random_sticker
...
def _main_menu_kb(lang: str, user_id: int) -> InlineKeyboardMarkup:
    ...
    # Home button — jumps back to the /start screen (callback_data='start',
    # handled in pm_filter_callbacks.py's cb_handler). Reuses the existing
    # BTN_HOME key ("🏠 Home").
    rows.append([
