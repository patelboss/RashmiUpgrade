...
class script:
    ...
    START_TXT        = EN.START
    HELP_TXT         = EN.HELP_MAIN
    ABOUT_TXT        = EN.ABOUT_TXT
    SOURCE_TXT       = EN.SOURCE_TXT
    MANUELFILTER_TXT = EN.HELP_CAT_FILTERS
    BUTTON_TXT       = ""   # content moved to HELP_CAT_EXTRA
    AUTOFILTER_TXT   = EN.HELP_CAT_SEARCH
    CONNECTION_TXT   = EN.HELP_CAT_CONNECT
    EXTRAMOD_TXT     = EN.HELP_CAT_EXTRA
    ADMIN_TXT        = EN.HELP_CAT_ADMIN
